...
tournament_registrations_role_router = APIRouter(prefix="/tournament_registrations", tags=["Tournament_registrations"])


@tournament_registrations_role_router.post("/")
...
@tournament_registrations_role_router.get("/get")
...
@tournament_registrations_role_router.put("/put")
...
@tournament_registrations_role_router.delete("/delete") #pt userii banati
